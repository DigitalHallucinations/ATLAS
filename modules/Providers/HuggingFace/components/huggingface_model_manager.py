...
class HuggingFaceModelManager:
    ...
    async def load_model(self, model_name: str, force_download: bool = False):
        ...
        try:
            ...
            if self.base_config.quantization == "8bit":
                quantization_config = BitsAndBytesConfig(
                    load_in_8bit=True, llm_int8_enable_fp32_cpu_offload=True
                )
            elif self.base_config.quantization == "4bit":
                quantization_config = BitsAndBytesConfig(
            ...
            if self.nvme_config.offload_nvme:
                ...
                model_kwargs["deepspeed"] = ds_config
            ...
            if self.base_config.use_bfloat16:
            ...
            if self.base_config.use_flash_attention and replace_attn_with_flash_attn is not None:
    ...
    async def fine_tune_model(
        ...
        if self.base_config.use_gradient_checkpointing:
        ...
        training_args = TrainingArguments(
            ...
            fp16=not self.base_config.use_bfloat16,
            bf16=self.base_config.use_bfloat16,
        ...
        if self.base_config.use_lora and LoRA is not None:
            self.logger.info("Applying LoRA for efficient fine-tuning")
            self.model = LoRA(self.model)
    ...
    def _freeze_layers(self, num_layers_to_freeze):
        """
        Strategy 20: Progressive Layer Freezing
        Freeze lower layers of the model during fine-tuning.
        """
