...
- [ ] **3.1** Create `core/services/calendar/reminder_service.py`
- [ ] **3.2** Define reminder types
- [ ] **3.3** Implement ReminderService
- [ ] **3.4** Implement background reminder scheduler
- [ ] **3.5** Connect to notification system
- [ ] **3.6** Write unit tests

### Phase 4: Job/Task Integration

- [ ] **4.1** Add event linking tables to calendar schema
- [ ] **4.2** Add linking methods to CalendarEventService
- [ ] **4.3** Add job/task-to-event creation
- [ ] **4.4** Subscribe to job/task MessageBus events
- [ ] **4.5** Write integration tests

### Phase 5: CalendarSyncService

- [ ] **5.1** Create `core/services/calendar/sync_service.py`
- [ ] **5.2** Define sync types
- [ ] **5.3** Implement CalendarSyncService
- [ ] **5.4** Move SyncEngine orchestration from UI
- [ ] **5.5** Emit comprehensive MessageBus events
- [ ] **5.6** Update SyncStatusPanel to use service
- [ ] **5.7** Write unit and integration tests

### Phase 6: Agent Calendar Integration

- [ ] **6.1** Add agent schedule methods to CalendarEventService
- [ ] **6.2** Add scheduling assistance
- [ ] **6.3** Replace `modules/Tools/Base_Tools/debian12_calendar.py`
- [ ] **6.4** Add agent context awareness
- [ ] **6.5** Configure agent permissions in `config.yaml`

### Phase 7: UI Updates for Integration

- [ ] **7.1** Update EventDialog to show linked jobs/tasks
- [ ] **7.2** Add "Create from Job" / "Create from Task" quick actions
- [ ] **7.3** Show job/task status on calendar events
- [ ] **7.4** Add calendar view filters
- [ ] **7.5** Add mini-calendar widget to Job/Task detail views
- [ ] **7.6** Subscribe all UI components to MessageBus
...
| `core/services/calendar/exceptions.py` | Service-specific exceptions |
| `core/services/calendar/event_service.py` | CalendarEventService |
| `core/services/calendar/sync_service.py` | CalendarSyncService |
| `core/services/calendar/reminder_service.py` | ReminderService |
| `modules/calendar_store/link_models.py` | Job/task link tables |
