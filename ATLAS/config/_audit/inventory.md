...
| ATLAS/config/messaging.py | @config-owners | 2026-07-02 | Aligned | Added Redis initial stream offset toggle; defaults remain non-prod. | 2026-10-02 | Keep messaging toggle docs and defaults aligned with Redis backend behavior. |
